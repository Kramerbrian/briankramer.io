...
const contentSecurityPolicy = [
  ...
  "object-src 'none'",
  "script-src 'self' 'unsafe-inline' https://va.vercel-scripts.com 'report-sample'",
  "script-src-elem 'self' 'unsafe-inline' https://va.vercel-scripts.com 'report-sample'",
  ...
  "child-src https://open.spotify.com https://www.youtube-nocookie.com",
...
const contentSecurityPolicyReportOnly = [
  ...
  "frame-ancestors 'none'",
  "object-src 'none'",
  "script-src 'self' https://va.vercel-scripts.com 'report-sample'",
  "script-src-elem 'self' https://va.vercel-scripts.com 'report-sample'",
  "script-src-attr 'none'",
