...
export const essays: EssayEntry[] = [
  {
    ...
    featured: true,
    body: `A customer in Naples asks ChatGPT: "Who's the best Toyota dealer near me?" The model answers with three store names. Yours isn't one of them — and you spent $14,000 on Google last month.
...
Most dealer sites 404 or redirect the moment a vehicle sells. The URL that Perplexity indexed last Tuesday is a ghost page today. Models learn that your inventory is unreliable. They stop citing it.
...
Half the dealer sites I audit have broken or missing schema. AI reads structured data first. If it's absent, the model moves on to your competitor's CarGurus listing.

## What AI models actually weight

I ran this experiment across ChatGPT, Perplexity, Gemini, and Google AI Overviews for a dozen stores I know well. The pattern is consistent:
...
But you can estimate it. If 71% of shoppers decide on a dealer before they call, and an increasing share of those shoppers start with an AI query instead of a Google search, every omission from an AI answer is a lead you never knew you lost.
...
AI visibility isn't a project. It's a beat — the new local SEO. The dealers who show up in these answers in 2027 are the ones who started treating their digital footprint like a citable source of record in 2026.`,
  },
  {
    ...
    featured: true,
    body: `Every day, dozens of trade-ready vehicles roll through your service drive. Most stores let them roll right back out. The ones that don't treat acquisition like infrastructure — not sales.
...
Every RO over a threshold — define it for your store, maybe $600, maybe $1,200 — gets a text with year, make, model, mileage, and VIN to a used-car buyer before the customer leaves the write-up desk. Not a batch at end of day. Not a sticky note on the dispatcher's monitor. A text, in 90 seconds.
...
If there's more than a few thousand in equity, that's an offer worth making. The math takes 30 seconds with the right tools. The hesitation takes weeks when you do it manually.

## Give the advisor a stake

Your service advisor is not paid to sell you cars. They are paid to sell hours and parts. If you want their attention on acquisition, they need a spiff — $100 to $250 per vehicle acquired through their lane. Small money. Changes behavior overnight.

I've watched stores go from zero drive-sourced units to 15–20 per month with nothing more than a spiff and a SLA. No new headcount. No new software. Just aligned incentives and a timer.
...
If close rate is under 20%, your offers are too low or your follow-up is too slow. If it's over 60%, you're leaving money on the table. Aim for 25–40%.
