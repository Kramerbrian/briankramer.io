...
export const publicClaimEvidence: PublicClaimEvidenceRecord[] = [
  ...
  record(
    ...
    'retired',
    'app/about/page.tsx',
    'Superseded by bio-years-automotive-retail (27 years in automotive retail) and bio-years-dealership-gm (19 years as a General Manager), both verified against employment history.',
    'remove',
    'Retired: this record conflated total retail tenure with GM tenure and asserted neither. Do not reintroduce two-decade framing while the superseding records remain verified.',
  ),
  record(
    'bio-years-automotive-retail',
    '27 years in automotive retail.',
    'biography-evidence',
    'verified',
    'app/page.tsx',
    'Verified against continuous employment history across automotive retail roles. Queue: svq-years-automotive-retail-27.',
    'publish',
    'Total retail tenure. Distinct from GM tenure (bio-years-dealership-gm) — do not conflate or sum the two figures.',
  ),
  record(
    'bio-years-dealership-gm',
    '19 years running dealerships as a General Manager.',
    'biography-evidence',
    'verified',
    'app/page.tsx',
    'Verified against employment history covering GM appointments across import, domestic, and luxury stores. Queue: svq-years-dealership-gm-19.',
    'publish',
    'GM tenure only, and a subset of the 27-year retail total (bio-years-automotive-retail). Do not present as additive.',
  ),
  record(
    'doctrine-acquisition-visual-models',
    'Trust, truth and clarity are the forces that survive the market; fear, ambiguity and hesitation divide acquisition force. Ownership is the result the market records.',
    'approved-doctrine',
    'verified',
    'app/doctrine/page.tsx',
    'Authored doctrine from The Best End User (Hollenshead & Kramer). Four visual models: the acquisition cover concept, the market inputs diagram, the ownership equation, and the trust-to-acquisition hierarchy. Rendered at /doctrine with captions and descriptive alt text.',
    'publish',
    'These are the authors’ own conceptual models, not empirical claims about market outcomes. Absolute phrasing ("the only result", "the only receipt", "the winning bid") is doctrine language reproduced from the artifacts and must not be read as a measured finding. Do not attach performance figures or dealer results to these models without separate evidence.',
  ),
  record(
