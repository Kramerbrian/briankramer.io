...
export const publicClaimEvidence: PublicClaimEvidenceRecord[] = [
  ...
  record(
    ...
    'publish',
    'Total retail tenure. Distinct from GM tenure (bio-years-dealership-gm) — do not conflate or sum the two figures. Not yet reflected in live page copy; hero/about rewrite is a separate step.',
  ),
  record(
    ...
    'publish',
    'GM tenure only, and a subset of the 27-year retail total (bio-years-automotive-retail). Do not present as additive. Not yet reflected in live page copy; hero/about rewrite is a separate step.',
  ),
  record(
